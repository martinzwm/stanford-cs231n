...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # We assume enough padding is used such at the output of the first conv layer
        # has the same H and W as the input.
        self.params['W2'] = weight_scale * np.random.randn(num_filters*H//2*W//2, hidden_dim)
        self.params['b2'] = np.zeros(hidden_dim)
        
        self.params['W3'] = weight_scale * np.random.randn(hidden_dim*1*1, num_classes)
    ...
    def loss(self, X, y=None):
        ...
        # for self.params[k]. Don't forget to add Ls2 regularization!               #
        #                                                                          #
